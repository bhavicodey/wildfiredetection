...
# =========================
# What Cerebras Does (BEFORE CLICK)
# =========================
st.warning(
    """
...
start_date = st.sidebar.date_input(
    "Start Date", datetime.utcnow() - timedelta(days=3)
)
...
• Likelihood of false positives (e.g., solar facilities, landfills)
